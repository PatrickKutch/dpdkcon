...
_Version = "9.16.24 Build 1"


class ArgParser(object):
    def __init__(self):
        parser = argparse.ArgumentParser(
            description="launcher - generic launcher for containers.\nContact Patrick Kutch for issues.",
            usage="""docker [docker options] app [app options] 
        ...
        parser.add_argument(
            "--testonly",
            help="parses all options and displays what the app [app options] would be, but does not execute them.",
            action="store_true",
        )
        ...
        if (
            ...
            parser.parse_args(
                ["--help"]
            )  # let argparse do the work for us, will exit after this
